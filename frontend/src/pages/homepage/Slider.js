...
const Slider = () => {
    ...
    return (_jsx("div", { className: "slider-container", children: _jsx("div", { className: "slider-track", style: {
                transform: `translateX(-${(CARD_WIDTH + GAP) * activeIndex}px)`,
            }, children: cards.map((card, i) => (_jsx(Card, { image: `${card}`, active: i === activeIndex, index: i, activeIndex: activeIndex }, i))) }) }));
};
